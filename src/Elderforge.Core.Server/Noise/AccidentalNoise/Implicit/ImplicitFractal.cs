...
public sealed class ImplicitFractal : ImplicitModuleBase
{
    ...
    public ImplicitFractal(
        FractalType fractalType, BasisType basisType, InterpolationType interpolationType, int octaves, double frequency,
        int seed
    )
    {
        _seed = seed;
    ...
    public override int Seed
    {
        ...
        set
        {
            ...
            {
                sources[source].Seed = _seed + source * 300;
            }
        }
    }
