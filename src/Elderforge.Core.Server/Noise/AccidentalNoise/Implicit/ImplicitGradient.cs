...
public sealed class ImplicitGradient : ImplicitModuleBase
{
    ...
    public void SetGradient(
        double x0, double x1, double y0, double y1, double z0, double z1, double w0, double w1, double u0, double u1,
        double v0, double v1
    )
    {
        gradientX0 = x0;
        ...
        length6 = gradientX1 * gradientX1 + gradientY1 * gradientY1 + gradientZ1 * gradientZ1 + gradientW1 * gradientW1 +
                  gradientU1 * gradientU1 + gradientV1 * gradientV1;
    }
    ...
    public override double Get(double x, double y, double z, double w, double u, double v)
    {
        ...
        var du = u - gradientU0;
        var dv = v - gradientV0;
        var dp = dx * gradientX1 + dy * gradientY1 + dz * gradientZ1 + dw * gradientW1 + du * gradientU1 + dv * gradientV1;
        dp /= length6;
        return dp;
    }
}
